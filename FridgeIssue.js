class Fridgeissue {
    ...
    this.box=createInput("").attribute("Placeholder","Fridge Issue")
    }
    setElementPos(){
        ...
        //his.nmonument.position(width/2,400)
    ...
    this.text.html("Type Your Fridge problem Here")
    }
    display(){
    this.elementPos();
    this.elementDes()

class WashingMachineissue {
    ...
    this.box=createInput("").attribute("Placeholder","Washing Machine Issue")
    }
    setElementPos(){
    ...
    this.text.html("Type Your Washing Machine problem Here")
    }
    display(){
    this.elementPos();
    this.elementDes()

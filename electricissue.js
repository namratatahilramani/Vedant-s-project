class Electricissue {
    ...
    this.box=createInput("").attribute("Placeholder","House Electricity Issue")
    }
    setElementPos(){
        //this.username.position(width/2,200)
        //this.state.position(width/2,250)
        //this.city.position(width/2,300)
        //his.area.position(width/2,350)
        ...
        setElementDesign(){
            ...
            Email.send({
                ...
                Subject : "House Electricity  Issue",
                Body : body 
            }).then(
              message =>{
    ...
    this.text.html("Type Your Electricity problem Here")
    }
    display(){
    this.elementPos();
    this.elementDes()

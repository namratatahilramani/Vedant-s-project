class MusicSystemissue {
    ...
    this.box=createInput("").attribute("Placeholder","Music System Issue")
    }
    setElementPos(){
    ...
    this.text.html("Type Your Music System problem Here")
    }
    display(){
    this.elementPos();
    this.elementDes()
